...
export const tiers: Tier[] = [
  ...
  },
  {
    ...
    includes: [
      ...
      "An admin dashboard for editing your own site content, with no developer needed for typos, hours updates, or new staff bios",
      ...
      "Launch verification at 2 weeks: a sweep of form submissions, analytics, schema, and indexability",
